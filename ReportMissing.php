...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $ownerID = $_POST["owner_id"]; // Assuming you have a way to identify the user, like through login

    // Insert the new item into the Items table
    $sql = "INSERT INTO Items (ItemName, Description, Category, FoundLocation, FoundDate, OwnerID)
            VALUES ('$itemName', '$description', '$category', '$foundLocation', '$foundDate', $ownerID)";
